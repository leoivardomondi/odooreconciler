...
dotenv_1.default.config({ path: paths_1.envFilePath });
...
exports.env = {
    ...
    APP_RUNTIME_CONFIG_PATH: (0, paths_1.resolveProjectFile)(process.env.APP_RUNTIME_CONFIG_PATH || './storage/runtime-config.json', 'storage/runtime-config.json'),
    ENABLE_DATABASE_INSTALLER: process.env.ENABLE_DATABASE_INSTALLER || 'false',
    SQLITE_PATH: (0, paths_1.resolveProjectFile)(process.env.SQLITE_PATH || './storage/app.db', 'storage/app.db'),
    ...
    AUTH_REQUEST_LIMIT_WINDOW_MINUTES: process.env.AUTH_REQUEST_LIMIT_WINDOW_MINUTES || '15',
    AUTH_REQUEST_LIMIT_MAX: process.env.AUTH_REQUEST_LIMIT_MAX || '5',
    AUTH_VERIFY_LIMIT_WINDOW_MINUTES: process.env.AUTH_VERIFY_LIMIT_WINDOW_MINUTES || '15',
    ...
    PAYROLL_BRIDGE_URL: process.env.PAYROLL_BRIDGE_URL || 'http://127.0.0.1:8010/odoo-payroll',
    PAYROLL_BRIDGE_PROXY_URL: process.env.PAYROLL_BRIDGE_PROXY_URL || 'http://127.0.0.1:8010/odoo-payroll',
    PAYROLL_BRIDGE_TOKEN: process.env.PAYROLL_BRIDGE_TOKEN || '',
    PAYROLL_ADVANCE_SOURCE: process.env.PAYROLL_ADVANCE_SOURCE || 'app.urbanvibeinteriordesign.co.ke',
    ...
    PAYROLL_PAY_RUN_NAME_TEMPLATE: process.env.PAYROLL_PAY_RUN_NAME_TEMPLATE || '{monthName} {year}',
    ODOO_TARGET_COMPANY_NAME: process.env.ODOO_TARGET_COMPANY_NAME || 'URBAN VIBE INTERIOR DESIGN COMPANY LTD',
};
