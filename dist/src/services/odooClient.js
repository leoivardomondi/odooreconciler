...
class OdooClient {
    ...
    async getBoardProducts(warehouseId) {
        ...
        if (categoryId !== null) {
            domain.push('|', '|', '|', '|', '|', '|', '|', ['categ_id', 'child_of', categoryId], ['name', 'ilike', 'board'], ['name', 'ilike', 'panel'], ['name', 'ilike', 'mdf'], ['name', 'ilike', 'plywood'], ['name', 'ilike', 'chipboard'], ['name', 'ilike', 'particle'], ['name', 'ilike', 'marine']);
        }
        else {
            domain.push('|', '|', '|', '|', '|', '|', ['name', 'ilike', 'board'], ['name', 'ilike', 'panel'], ['name', 'ilike', 'mdf'], ['name', 'ilike', 'plywood'], ['name', 'ilike', 'chipboard'], ['name', 'ilike', 'particle'], ['name', 'ilike', 'marine']);
        }
